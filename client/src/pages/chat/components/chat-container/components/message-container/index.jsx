...
const MessageContainer = () => {
    ...
    >
      {checkIfImage(message.fileUrl) ? (
        ...
        <div className="flex items-center justify-center gap-4">
          ...
          <span className="bg-black/20 rounded-full p-3 text-2xl hover:bg-black/50 cursor-pointer transition-all duration-300"
        ...
        message.sender._id!==userInfo.id? <div className="flex items-center justify-start gap-3">
          <Avatar className="h-8 w-8 rounded-full overflow-hidden">
                        {message.sender.image && (
                            <AvatarImage
                                src={`${HOST}/${message.sender.image}`} alt="profile" className="object-cover w-full bg-black"
                            />
                        )}
  ...
  return (
    <div className="flex-1 overflow-y-auto scrollbar-auto-hide p-4 px-8 md:w-[65vw] lg:w-[70vw] xl:w-[80vw] w-full">
      {renderMessages()}
      <div ref={scrollRef} />
      {showImage && (
  <div className="fixed z-[1000] top-0 left-0 h-[100vh] w-[100vw] flex items-center justify-center backdrop-blur-">
    <div>
      <img
        src={`${HOST}/${imageUrl}`}
