...
const Profile = () => {
  ...
  const validateProfile=()=>{
    if(!firstName){
      toast.error("First name is requied");
      return false;
    }
    if(!lastName){
  ...
  return (
    <div className="bg-[#1b1c44] h-[100vh] flex items-center justify-center flex-col gap-10">
        ...
        <div className="grid grid-cols-2">
          ...
          >           
            <Avatar className="h-32 w-32 md:w-48 md:h-48 rounded-full overflow-hidden">
              {image?(
                <AvatarImage
                src={image} alt="profile" className="object-cover w-full bg-black"
                />
              ):(
